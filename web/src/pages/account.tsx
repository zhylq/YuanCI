...
function AccountPage() {
  ...
  return <div className="space-y-6">
    ...
    <section className="rounded-xl border border-slate-200 bg-white p-6"><h2 className="text-balance text-lg font-semibold">进入你的项目</h2><p className="mt-2 text-pretty leading-7 text-slate-600">查看已获授权的仓库资料和运行记录。新实例可能尚无项目；仓库安装、导入与 Runner mTLS 将继续接入。</p><Link className={`${linkClass} mt-4 inline-flex min-h-11 items-center`} to="/projects">查看项目列表</Link></section>
  </div>
}
